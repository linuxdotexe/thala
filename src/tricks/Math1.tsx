...
export default function Math1(text: string) {
    const elements = [
        ...
        <Latex>Multiplying that ${text.length.toString()}$ with $14$ gives us:</Latex>,
        <Latex>${text.length.toString()}*14 = {(text.length*14).toString()}$</Latex>,
        <Latex>Dividing this ${(text.length*14).toString()}$ with $2$ gives us:</Latex>,
        <Latex>${(text.length*14).toString()}/2 = {(text.length*7).toString()}$</Latex>,
